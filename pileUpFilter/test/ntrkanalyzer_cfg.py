...
process.p1 = cms.Path( process.pileUpFilter_vtx1*process.ana_PbPb1 )
process.p2 = cms.Path( process.pileUpFilter_Gplus*process.ana_PbPb2 )
process.p3 = cms.Path( process.olvFilter_dz1p0*process.ana_PbPb3 )
